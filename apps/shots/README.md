...
Drop in a screenshot and get a clean product shot back. Four neutral backgrounds,
nothing else.

```bash
pnpm --filter shots dev     # http://localhost:3000
```
...
| `@design-tools/ui` | The primitives the panel is built from — shared across every tool. |
...
Part of [design-tools](../../README.md); repo conventions live in
`../../CLAUDE.md`.
